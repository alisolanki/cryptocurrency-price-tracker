...
class CryptoPriceTracker(tk.Tk):
    def __init__(self):
        ...
        self.label = ttk.Label(self, text="Choose a cryptocurrency:")
        self.label.pack(pady=20)
        
        self.crypto_var = tk.StringVar()
        self.crypto_dropdown = ttk.Combobox(self, textvariable=self.crypto_var, values=["bitcoin", "ethereum", "litecoin"])
